...
@Component({
    selector: 'jhi-bank-account-ang',
    templateUrl: './bank-account-ang.component.html'
})
export class BankAccountAngComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/bank-account-ang'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    clear() {
        this.page = 0;
        this.router.navigate(['/bank-account-ang', {
            page: this.page,
            sort: this.predicate + ',' + (this.reverse ? 'asc' : 'desc')
        }]);
        this.loadAll();
    ...
    trackId(index: number, item: BankAccountAng) {
        return item.id;
    }
