...
@Component({
    selector: 'jhi-transaction-ang',
    templateUrl: './transaction-ang.component.html'
})
export class TransactionAngComponent implements OnInit, OnDestroy {

    transactions: TransactionAng[];
    currentAccount: any;
    ...
    trackId(index: number, item: TransactionAng) {
        return item.id;
    }
