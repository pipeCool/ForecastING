...
export class TransactionMySuffixService {
    ...
    create(transaction: TransactionMySuffix): Observable<TransactionMySuffix> {
    ...
    update(transaction: TransactionMySuffix): Observable<TransactionMySuffix> {
        const copy = this.convert(transaction);
    ...
    find(id: number): Observable<TransactionMySuffix> {
